                  ...
                  <ul className="sidebar-nav">
                      <li className="sidebar-item">
                        ...
                        <li className="sidebar-item">
                            ...
                            <NavLink exact={true} activeClassName='is-active' to="/" className="navlink">
                        ...
                        <li className="sidebar-item">
                        <div className="sidebar-link">
                            <NavLink exact={true} activeClassName='is-active' to="/builds" className="navlink">
                        ...
                        <li className="sidebar-item">
                            <div className="sidebar-link">
                                <NavLink activeClassName='is-active' to="/help" className="navlink">
