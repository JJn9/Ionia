...
import Ionia from './bundles/assets/images/Ionia-white.png';
      ...
      <div>
        <nav className="sidebar">
                  <ul className="sidebar-nav">
                      <li className="logo">
                          <NavLink to="/ionia/home" className="logo-link">
                              <img src={Ionia} className="ionia-logo"></img>
                          </NavLink>
                      </li>
                      <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-right">Home</Tooltip>}>
                          <li className="sidebar-item">
                              <NavLink exact={true} activeClassName='is-active' to="/" className="sidebar-link">
                      ...
                      <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-right">Builds</Tooltip>}>
                          <li className="sidebar-item">
                              <NavLink exact={true} activeClassName='is-active' to="/builds" className="sidebar-link">
                      ...
                      <OverlayTrigger placement='bottom' overlay={<Tooltip id="tooltip-right">Help</Tooltip>}>
                          <li className="sidebar-item">
                              <NavLink activeClassName='is-active' to="/help" className="sidebar-link">
